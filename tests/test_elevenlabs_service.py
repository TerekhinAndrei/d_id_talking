...
class TestElevenLabsService:
    ...
    @patch('app.services.elevenlabs_service.config')
    def test_validate_configuration_failure(self, mock_config):
        """Test _validate_configuration without API key"""
        mock_config.is_elevenlabs_configured.return_value = False
    ...
    def test_get_headers(self, mock_config):
        ...
        mock_config.get_elevenlabs_headers.return_value = {
            "xi-api-key": "test_key",
    ...
    def test_make_request_success(self, mock_get, mock_config):
        ...
        mock_config.is_elevenlabs_configured.return_value = True
        mock_response = Mock()
    ...
    @patch('app.services.elevenlabs_service.config')
    @patch('app.services.elevenlabs_service.requests.get')
    def test_make_request_api_error(self, mock_get, mock_config):
    ...
    @patch('app.services.elevenlabs_service.config')
    @patch('app.services.elevenlabs_service.requests.get')
    def test_make_request_network_error(self, mock_get, mock_config):
    ...
    def test_speech_to_speech_success(self, mock_post, mock_config):
        ...
        mock_response.headers.get.return_value = "audio/wav"
    ...
    @patch('app.services.elevenlabs_service.config')
    @patch('app.services.elevenlabs_service.requests.post')
    def test_speech_to_speech_no_audio_response(self, mock_post, mock_config):
    ...
    @patch('app.services.elevenlabs_service.config')
    @patch('app.services.elevenlabs_service.requests.get')
    def test_get_available_voices_success(self, mock_get, mock_config):
    ...
    @patch('app.services.elevenlabs_service.config')
    @patch('app.services.elevenlabs_service.requests.get')
    def test_validate_voice_id_true(self, mock_get, mock_config):
    ...
    @patch('app.services.elevenlabs_service.config')
    @patch('app.services.elevenlabs_service.requests.get')
    def test_validate_voice_id_false(self, mock_get, mock_config):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {
            "voices": [{"voice_id": "other_voice", "name": "Other Voice"}]
        }
        mock_get.return_value = mock_response
