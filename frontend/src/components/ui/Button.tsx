...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-elevated text-primary border border-primary hover:bg-tertiary hover:border-secondary focus:ring-primary-500',
    ghost: 'bg-transparent text-primary border border-transparent hover:bg-elevated focus:ring-primary-500',
  };
